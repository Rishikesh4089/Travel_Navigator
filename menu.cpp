...
void TravelNavigator::tour_select(){
    ...
    if(g.pathFinderBool(n.tourDays(), n.startNode(), n.endNode())==true){
...
void TravelNavigator::Data(){
    ...
    user_details();
    tour_select();
    cout<<"         Enter 0 For Home                                                                                                            "<<endl<<endl;
    cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
    cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
    cin>>x;
    switch(x){
...
void onlyDisplay::menu(){
    ...
    cout<<"**                                     2.List of states offered                                                                   **"<<endl;
    cout<<"**                                     3.Exit                                                                                        **"<<endl;
    cout<<"**                                                                                                                                   **"<<endl;
    cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
    cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
...
void onlyDisplay::map(){
    ...
    cout<<"**                                               Shimla        Rishikesh      Manali                                                 **"<<endl;
    cout<<"**                                                                                                                                   **"<<endl;
